...
1. In Gitea, click on your user avatar at the top right, then select **Settings** > **Applications**.
   ...
   ![Applications](/img/projects/devsecops/devsecops-home-lab/create-configure-pipeline/gitea-manage-access-tokens.png)

2. Enter a token name (e.g., `Jenkins`), set it to `Private`, and select all permissions as READ/WRITE. Click **Generate Token**.

   ![Generate Token](/img/projects/devsecops/devsecops-home-lab/create-configure-pipeline/gitea-configure-token-permissions.png)
...
1. Log into Jenkins. From the **Dashboard**, click **Manage Jenkins** > **Manage Plugins**.
   ...
   ![Manage Plugins](/img/projects/devsecops/devsecops-home-lab/create-configure-pipeline/jenkins-manage-plugins.png)
...
2. Under **Available Plugins**, search for and install the following:
   ...
   ![Install Plugins](/img/projects/devsecops/devsecops-home-lab/create-configure-pipeline/jenkins-install-plugins.png)

## Step 3: Create Jenkins Pipeline

1. From the Jenkins **Dashboard**, click **New Item**.

   ![New Item](/img/projects/devsecops/devsecops-home-lab/create-configure-pipeline/jenkins-dashboard.png)

2. Select **Organization Folder** and name it (e.g., `OWASP Juice Shop Pipeline`).

   ![Organization Folder](/img/projects/devsecops/devsecops-home-lab/create-configure-pipeline/jenkins-organization-folder.png)

3. Scroll down to **Repository Sources** and select **Gitea Organization**.

   ![Repository Sources](/img/projects/devsecops/devsecops-home-lab/create-configure-pipeline/jenkins-configure-gitea-pipeline.png)
...
4. Under **Credentials**, click **Add**. Select the organization folder name, set the **Kind** to **Gitea Personal Access Token (PAT)**, and paste the token generated from Gitea.
   ...
   ![Gitea PAT](/img/projects/devsecops/devsecops-home-lab/create-configure-pipeline/jenkins-configure-gitea-pat.png)

5. Set the **Owner** to your Gitea username, and then click **Apply** and **Save**.

   ![Save Configuration](/img/projects/devsecops/devsecops-home-lab/create-configure-pipeline/jenkins-config-gitea-organization.png)
...
1. In Jenkins, go to **Manage Jenkins** > **Configure System**. Scroll down to **Gitea Servers** and add your Gitea server details.
   ...
   ![Gitea Server](/img/projects/devsecops/devsecops-home-lab/create-configure-pipeline/jenkins-config-gitea-server.png)
...
3. In Gitea, navigate to the project, click on **Settings** > **Webhooks**.
   ...
   ![Webhooks](/img/projects/devsecops/devsecops-home-lab/create-configure-pipeline/gitea-config-webhook.png)
...
4. Click **Add Webhook**, then select **Gitea**. Fill out the form:
   ...
   ![Add Webhook](/img/projects/devsecops/devsecops-home-lab/create-configure-pipeline/gitea-add-webhook-jenkins.png)
...
3. In Jenkins, go to **Manage Jenkins** > **Credentials** > **System** > **Global Credentials (unrestricted)**. Select **Add Credentials** and choose **SSH Username with private key**.
   ...
   ![SSH Credentials](/img/projects/devsecops/devsecops-home-lab/create-configure-pipeline/jenkins-config-ssh-username.png)
