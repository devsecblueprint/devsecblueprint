...
1. Navigate to the **Azure DevOps project** called `python-fastapi`.
   ![Azure DevOps Project](/img/projects/devsecops/devsecops-pipeline-azure/deployment-and-testing/image-3.png)

2. Click the project, then select **Pipelines**. Under the **All** tab, click the pipeline named **Default**.
   ![Default Pipeline](/img/projects/devsecops/devsecops-pipeline-azure/deployment-and-testing/image-4.png)

3. Click **Run pipeline** and wait for the results. This process typically takes **15–20 minutes**.
   ![Run Pipeline](/img/projects/devsecops/devsecops-pipeline-azure/deployment-and-testing/image-5.png)
...
![Trivy Dependency Scan](/img/projects/devsecops/devsecops-pipeline-azure/deployment-and-testing/image-6.png)
...
![Trivy Image Scan](/img/projects/devsecops/devsecops-pipeline-azure/deployment-and-testing/image-7.png)
...
![ZAP Scan Results](/img/projects/devsecops/devsecops-pipeline-azure/deployment-and-testing/image-8.png)
...
1. Log in to the **Azure Portal** and search for your container registry (`DSBContainerRegistry`).
   ...
   - Navigate to **Repositories** → `python-fastapi`.
     ![Container Registry Repo](/img/projects/devsecops/devsecops-pipeline-azure/deployment-and-testing/image-9.png)

2. Click the repository link and verify that a new image tag has been published.
   ![Image Tag](/img/projects/devsecops/devsecops-pipeline-azure/deployment-and-testing/image-10.png)
