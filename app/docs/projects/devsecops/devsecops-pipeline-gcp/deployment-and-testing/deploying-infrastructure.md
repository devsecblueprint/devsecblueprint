...
2. Navigate to **Actions** and click on `.github/workflows/main.yml`.
   ...
   ![alt text](/img/projects/devsecops/devsecops-pipeline-gcp/deployment-and-testing/github_action.png)
...
4. Confirm that the plans have been applied successfully. You should see successful builds in both GitHub and Terraform Cloud. Example results are shown below:
   ...
   **GitHub Pipeline Execution**:
   ![alt text](/img/projects/devsecops/devsecops-pipeline-gcp/deployment-and-testing/completed_github_action.png)

   **Terraform Cloud Deployment**:
   ![alt text](/img/projects/devsecops/devsecops-pipeline-gcp/deployment-and-testing/completed_tf_run.png)
