...
3. Choose **GitHub** as the host provider and fill out the necessary details:
   ![GitHub Connection](/img/projects/devsecops/devsecops-pipeline-gcp/setup/github-connection.png)
4. If you are a new user, click **Install in a new account** to authorize access:
   ![Install GitHub App](/img/projects/devsecops/devsecops-pipeline-gcp/setup/cloud-build-github-install.png)
5. Select your GitHub namespace or organization. Once done, your repositories and connections should appear:
   ![Repositories Connected](/img/projects/devsecops/devsecops-pipeline-gcp/setup/verifying-connections.png)
...
3. Choose the repository you want to create a trigger for and click **Link**:
   ![Link Repository](/img/projects/devsecops/devsecops-pipeline-gcp/setup/link-repositories.png)
...
4. **Skip creating a trigger** at this stage if you want to manually configure it later:
   ![Connect Repository](/img/projects/devsecops/devsecops-pipeline-gcp/setup/connecting-repositories.png)
