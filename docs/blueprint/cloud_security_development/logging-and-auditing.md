...
| ----------------------------- | ------------------ | --------------------------------- | -------------------------------------------------------------------- |
| Cloud Observability in Action | Michael Hausenblas | [Amazon](https://amzn.to/4qH8RXP) | Explains how to design scalable log management and analysis systems. |
...
<iframe
  width="100%"
  height="480"
  src="https://www.youtube.com/embed/2BZC8b_0ZAI?si=PZaUKzg_6y2gvQct"
  frameborder="0"
...
<iframe
  width="100%"
  height="480"
  src="https://www.youtube.com/embed/gOuAqRaDdHA?si=WrD7stawyBPiMU2g"
  frameborder="0"
  allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
  allowfullscreen
></iframe>
