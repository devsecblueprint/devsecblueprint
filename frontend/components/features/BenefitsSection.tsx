import { HOMEPAGE_BENEFITS } from '@/lib/data/homepage';
import type { HomepageBenefit } from '@/lib/data/homepage';
...
function BenefitItem({ benefit }: { benefit: HomepageBenefit }) {
  return (
...
function BenefitIcon({ icon }: { icon: HomepageBenefit['icon'] }) {
  const className = 'w-10 h-10 text-primary-500 dark:text-primary-400';
