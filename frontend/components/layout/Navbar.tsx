    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 h-16">
      <div className="h-full px-6 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-2 lg:space-x-6">
          ...
          {/* Sponsorships Link - Always visible */}
          <a
            href="/sponsorships"
            className={getLinkClasses(
              '/sponsorships',
            ...
            aria-current={isLinkActive('/sponsorships') ? 'page' : undefined}
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {isMobileMenuOpen && (
        <div className="lg:hidden bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800 px-6 py-4">
          ...
          <div className="space-y-3 mb-4">
            ...
            {/* Pricing Link - Always visible on mobile */}
            <a 
              href="/pricing"
              className={getLinkClasses(
                '/pricing',
            ...
            {/* Sponsors Link - Always visible on mobile */}
            <a 
              href="/sponsorships"
              className={getLinkClasses(
                '/sponsorships',
