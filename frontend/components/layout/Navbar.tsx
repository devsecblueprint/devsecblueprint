      ...
      <div className="h-full px-6 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-2 lg:space-x-6">
          ...
          <a
            ...
            aria-current={isLinkActive('/videos') ? 'page' : undefined}
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="hidden lg:block">
            <NavDropdown label="About" items={aboutItems} isActive={isLinkActive('/about') || isLinkActive('/sponsorships')} />
          </div>
      ...
      {isMobileMenuOpen && (
        <div className="lg:hidden bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800 px-6 py-4">
          ...
          <div className="space-y-3 mb-4">
            ...
            {/* Videos Link - Only for unauthenticated users on mobile */}
            {!isAuthenticated && (
              <a 
                href="/videos/preview"
                className={getLinkClasses(
