# =============================================================================
# IAM Roles for ECS Fargate (Task Execution Role + Task Role)
# =============================================================================
...
resource "aws_iam_role_policy" "ecs_execution_permissions" {
  name = "${var.project_name}-ecs-execution-permissions"
...
# -----------------------------------------------------------------------------
# ECS Task Role
# Used by the application container at runtime to access AWS services
# -----------------------------------------------------------------------------
...
# DynamoDB access for progress, user-state, and membership tables
...
# S3 access for content registry bucket
